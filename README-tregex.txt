...
Java version 1.5 is required to use Tregex.  If you really want to use
...
src
  ...
  A directory containing the Java 1.5 source code for the Tregex
  distribution.
