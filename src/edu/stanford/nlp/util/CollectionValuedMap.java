 ...
 * Important methods are the {@link #add(K key,V value)} and
 * {@link #removeMapping(K key, V value)} methods for adding and removing a value
 * to/from the Collection associated with the key, and the {@link #get(Object)} method for
