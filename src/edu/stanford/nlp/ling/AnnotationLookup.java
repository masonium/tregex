...
import edu.stanford.nlp.ling.CoreAnnotations.NormalizedNERAnnotation;
...
public class AnnotationLookup {
  ...
  public enum KeyLookup {
    ...
    TAG_KEY(TagAnnotation.class, OldFeatureLabelKeys.TAG_KEY),
    ...
    NER_KEY(NERAnnotation.class, OldFeatureLabelKeys.NER_KEY),
    ...
    BEGIN_POSITION_KEY(BeginPositionAnnotation.class, OldFeatureLabelKeys.BEGIN_POSITION_KEY),
    END_POSITION_KEY(EndPositionAnnotation.class, OldFeatureLabelKeys.END_POSITION_KEY),
    ...
    END_POSITION_KEY2(EndPositionAnnotation.class, "endPosition"),
    CHUNK_KEY(ChunkAnnotation.class, "chunk"),
    NORMALIZED_NER_KEY(NormalizedNERAnnotation.class, "normalized"),
