...
//  buttonBox.add(emptyLabel2, buttonConstraints);
    ...
    Thread browseThread = new Thread() {
      ...
      public void run() {
        ...
        for (int i = 0; i < treebanks.size(); i++) {
          ...
          updateProgressBar(multiplier*i++);
        }
        SwingUtilities.invokeLater(new Runnable() {
   ...
   */
  public void doError(final String txt, final Exception e) {
    SwingUtilities.invokeLater(new Runnable() {
      public void run() {
  ...
  public static class TRegexGUITreeVisitor implements TreeVisitor {
    ...
    private TregexPattern p;
    private List<TreeFromFile> matchedTrees;
    ...
    public void visitTree(Tree t) {
      ...
      List<Tree> matchedPartList = new ArrayList<Tree>();
      while (match.find()) {
  ...
  private static final String htmlTsurgeonHelp = ( "<html>" +
  ...
  " <dt><code>replace &#60;name1&#62; &#60;name2&#62;</code></dt> <dd>deletes name1 and inserts a copy of name2 in its place.</dd>" +
  " <dt><code>adjoin &#60;auxiliary_tree&#62; &lt;name&gt;</code></dt> <dd>Adjoins the specified auxiliary tree into the named node.  The daughters of the target node will become the daughters of the foot of the auxiliary tree.</dd>" +
  " <dt><code>adjoinH &#60;auxiliary_tree&#62; &lt;name&gt;</code></dt> <dd>similar to adjoin, but preserves the target node and makes it the root of &lt;tree&gt;</dd>" +
  ...
  "  It thus retains its status as parent of its children, placed in the appropriate spot in &lt;tree&gt;.</dd>" +

  " <dt>coindex &#60;name1&#62; &#60;name2&#62; ... &#60;nameM&#62; </code></dt>  <dd>Puts a (Penn Treebank style) coindexation suffix of the form \"-N\" on" +
