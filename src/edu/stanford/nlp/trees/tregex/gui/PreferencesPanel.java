...
public class PreferencesPanel extends JDialog {
  ...
  public PreferencesPanel(TregexGUI gui) {
    ...
    final JComboBox headfinderPicker = new JComboBox(new String[] {"ArabicHeadFinder", "BikelChineseHeadFinder", "ChineseHeadFinder", "ChineseSemanticHeadFinder", "CollinsHeadFinder", "LeftHeadFinder", "ModCollinsHeadFinder", "NegraHeadFinder", "SemanticHeadFinder", "SunJurafskyChineseHeadFinder", "SwbdHeadFinder", "TueBaDZHeadFinder"}); //
    ...
    final JComboBox trfPicker = new JComboBox(new String[] {"ArabicTreeReaderFactory", "ArabicTreeReaderFactory.ArabicRawTreeReaderFactory", "ArabicTreeReaderFactory.ArabicXFilteringTreeReaderFactory", "CTBTreeReaderFactory", "Basic categories only (LabeledScoredTreeReaderFactory)", "NoEmptiesCTBTreeReaderFactory", "PennTreeReaderFactory", "TregexPattern.TregexTreeReaderFactory" });
