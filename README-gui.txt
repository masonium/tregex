Tregex GUI v1.4 - 30 Aug 2009
----------------------------------------------

Copyright (c) 2003-2009 The Board of Trustees of 
...
This release prepared by Chris Manning.

----------------------------
TREGEX GRAPHICAL USER INTERFACE (GUI) README
----------------------------

The Tregex GUI is a graphical user interface for Tregex and Tsurgeon.  You can access it by double-
clicking on the jar file tregex.jar. For searching large treebanks, you may need to use more memory;
the script run-tregex-gui.command includes this allocation of memory and can be run from the command line
or double-click to run on a Mac. If you still have memory problems, you can allot more memory by opening 
the script in a text editor and changing "-mx300m" to include a bigger number (e.g., "-mx512m").  Tregex 
requires Java 1.5+.  
Further documentation for Tregex and Tsurgeon can be found in README-tregex.txt and 
...
File filters are combined such that all loaded files must obey all of the filters; only one filter of any given
...
----------------------------
 ...
 Tregex GUI
 Copyright (c) 2007-2009 The Board of Trustees of 
 The Leland Stanford Junior University. All Rights Reserved.
...
This section summarizes changes between released versions of Tregex GUI.

Version 1.4 2009-09-30
    GUI slider for tree size, (incompatibly) generalized relabel
    command, __ and @ now supported in path constraints; bugfixes.
Version 1.1  2008-05-06
    Several bug fixes; addition of browse trees function, improved copy/paste and drag and drop support;
